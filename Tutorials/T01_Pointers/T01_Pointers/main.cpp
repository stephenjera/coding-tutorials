...
int main()
{
	...
	ChPoint = &Ch; // Assign the address of ch to pointer variable 
	...
	*ChPoint = 'B';
	...
	int Integer; // Declare integer variable
	...
	*p = 12; // Assign 12 to 
	...
	int Integer1 = 4, Integer2 = 5, Integer3 = 6; // Declare and initialise 3 interger 
	...
	*IntegerPointer2 = Integer1 + Integer3; // Assign sum to Integer2
	...
	cout << Integer1 << " " << Integer2 << " " << Integer3 << " " << endl; //Print values in integer variables 
